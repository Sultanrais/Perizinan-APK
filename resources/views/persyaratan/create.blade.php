...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Form Tambah Persyaratan</h3>
    </div>
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <select class="form-control @error('tipe_file') is-invalid @enderror" 
                    ...
                    <option value="image" {{ old('tipe_file') === 'image' ? 'selected' : '' }}>Gambar</option>
                    <option value="pdf,image" {{ old('tipe_file') === 'pdf,image' ? 'selected' : '' }}>PDF & Gambar</option>
                </select>
                @error('tipe_file')
                <span class="invalid-feedback">{{ $message }}</span>
                @enderror
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control @error('max_size') is-invalid @enderror" 
                       id="max_size" name="max_size" value="{{ old('max_size', 2048) }}" 
